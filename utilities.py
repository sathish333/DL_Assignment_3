...
class Seq2Seq(nn.Module):
    ...
    def forward(self,source,target,prediction=False):
        ...
        hidden=hidden.repeat(self.config.decoder_num_layers,1,1)
...
#         self.cell = nn.GRU(config.hidden_size, config.hidden_size,config.decoder_num_layers)
